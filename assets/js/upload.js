  ...
  overlay.innerHTML = `
    <div class="upload-modal">
      ...
      <div class="disclaimer">
        <strong>Warning:</strong> The file will be uploaded to a free image hosting service (<a href="https://freeimage.host" target="_blank">freeimage.host</a>).  Please do not upload any files that were not made free to the public by the original creator.
      </div>
    </div>
  `;
