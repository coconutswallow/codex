(function() {
  ...
  const styles = `
    ...
    .upload-modal { background: white; padding: 2rem; border-radius: 8px; width: 300px; text-align: center; font-family: sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
  ...
  overlay.innerHTML = `
    <div class="upload-modal">
      ...
      <button onclick="document.getElementById('u-overlay').style.display='none'" style="margin-left:10px; cursor:pointer; background:none; border:none; text-decoration:underline;">Cancel</button>
      <div id="u-status" style="margin-top:10px; font-size:0.9em;"></div>
    </div>
  `;
  document.body.appendChild(overlay);

  // --- LISTEN FOR CLICKS ON ANY UPLOAD BUTTON ---
