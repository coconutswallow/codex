...
1. **Rule of cool**.  Creative interpretations of rules can be accepted, as long as it's for positive fun and not detriment to other players
2. Creative **shenanigans are welcome** and potentially rewarded even if they don't pan out 
3. **You are responsible for knowing the rules** and limitations of your abilities and spells
4. I am not a super experienced DM that has all the rules memorized.  **Please help** me out.
5. **We all have responsibility to make the game fun and inclusive for all**

## Combat

- **No silvery barbs**
- **Flanking Rules:**  +2 to attack rolls from flanking.  Flanking only works if you are in melee and two party members are on opposite sides of each other.
- **Nat 1s or multiple misses**:  these are opportunities for creative role-play.  It doesn't need to be just "miss" it could an epic battle of parries, etc.  Creative role-play of misses can result in awards like DM inspiration.
- **Familiars** roll their own initiatives (automated by Avrae)

- **Special Actions**: 

    - **Study Action**: 
        - If your character is unfamiliar with the enemy, you can use an attack action to study the enemy for characteristics, potential weaknesses, etc. 
